...
<body>
    ...
    <div class="alert alert-danger" style="width:200px; color:cornflowerblue; background-color:red" role="alert">
        <?= $mssg; ?>
    </div>
    <div>
        <form method="post" action="" id="leemah">
